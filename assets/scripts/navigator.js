        ...
        const gotoNum = (index) => {
            if ((index != current) && !animation_state) {
                if (current == 1 && index == 2){
                    document.getElementById('wefoot1').classList.add("animate");
                    document.getElementById('arrowleft').classList.add("arrowleftanim");
                    document.getElementById('wefoot1').classList.remove("unanimate");
                }
                else if (index == 1 && current == 2){
                    console.log(current);
                    document.getElementById('wefoot1').classList.add("unanimate");
                    // document.getElementById('wefoot1').classList.remove("animate");
                }
